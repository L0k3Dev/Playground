...
// End Cross Module References
	...
	template<> PLAGROUND_API UClass* StaticClass<ABaseCharacter>()
	{
		return ABaseCharacter::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ABaseCharacter);
	ABaseCharacter::~ABaseCharacter() {}
	struct Z_CompiledInDeferFile_FID_Dev_Playground_Plaground_Source_Plaground_Characters_BaseCharacter_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Dev_Playground_Plaground_Source_Plaground_Characters_BaseCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ABaseCharacter, ABaseCharacter::StaticClass, TEXT("ABaseCharacter"), &Z_Registration_Info_UClass_ABaseCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABaseCharacter), 3973712090U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Dev_Playground_Plaground_Source_Plaground_Characters_BaseCharacter_h_2943312174(TEXT("/Script/Plaground"),
		Z_CompiledInDeferFile_FID_Dev_Playground_Plaground_Source_Plaground_Characters_BaseCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Dev_Playground_Plaground_Source_Plaground_Characters_BaseCharacter_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
